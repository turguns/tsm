...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">KGS</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" KGS" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
